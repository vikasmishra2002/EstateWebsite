...
const PropertiesGridView = () => {
  return (
    <div className="relative bg-gray-white w-full flex flex-col items-start justify-start text-center text-33xl text-gray-white font-body-regular-400">
      <Header />
      <div className="self-stretch h-60 flex flex-col items-center justify-center bg-[url(/public/category@3x.png)] bg-cover bg-no-repeat bg-[top]">
      ...
      <ShubhsyaContainer
        productIds="/houseline3.svg"
        productLinks="_blank"
        productImageIds="/social-media-logo5.svg"
        productImageIds20x20="/social-media-logo6.svg"
        productImageLinks="_blank"
        productImageIds20x20x="/social-media-logo7.svg"
        productImageIds20x20xSmal="/social-media-logo8.svg"
        productImageIds20x20xMedi="/social-media-logo9.svg"
        propFlex="unset"
